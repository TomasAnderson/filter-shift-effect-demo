...
/***/ function(module, exports, __webpack_require__) {
	...
	var allColors = ['#456990', '#EF767A', '#49BEAA', '#49DCB1', '#EEB868', '#EF767A', '#456990', '#49BEAA', '#49DCB1', '#EEB868', '#EF767A'];
	
	var springSetting1 = { stiffness: 180, damping: 10 };
	var springSetting2 = { stiffness: 120, damping: 17 };
	
	var names = ['dark blue', 'red', 'dark green', 'light green', 'yellow', 'red', 'dark blue', 'dark green', 'green', 'yellow', 'red'];
	...
	var reinsert = function reinsert(oldOrder, value) {
		...
		render: function render() {
			return React.createElement(
				...
				React.createElement(
					...
					this.props.names[this.props.key]
				)
			);
		}
	});
