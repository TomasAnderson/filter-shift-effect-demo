...
/***/ function(module, exports, __webpack_require__) {
	...
	var grids = [{ color: '#456990', name: 'dark blue' }, { color: '#EF767A', name: 'red' }, { color: '#49BEAA', name: 'dark green' }, { color: '#49DCB1', name: 'light green' }, { color: '#EEB868', name: 'yellow' }, { color: '#EF767A', name: 'red' }, { color: '#456990', name: 'dark blue' }, { color: '#49BEAA', name: 'dark green' }, { color: '#49DCB1', name: 'green' }, { color: '#EEB868', name: 'yellow' }, { color: '#EF767A', name: 'red' }];
	
	ReactDOM.render(React.createElement(App, { grids: grids }), document.querySelector('#app'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Motion = __webpack_require__(97);
	
	exports.Motion = _interopRequire(_Motion);
	
	var _StaggeredMotion = __webpack_require__(98);
	
	exports.StaggeredMotion = _interopRequire(_StaggeredMotion);
	
	var _TransitionMotion = __webpack_require__(99);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(18);
	var ExpandableDiv = __webpack_require__(94);
	var range = __webpack_require__(95);
	var Motion = __webpack_require__(59).Motion;
	var spring = __webpack_require__(59).spring;
	...
	var App = React.createClass({
		...
		_reinsert: function _reinsert(oldOrder, value) {
		...
		handleRemove: function handleRemove(key) {
			return (function () {
				var newGirds = key === 0 ? this.state.grids.slice(1) : key === this.state.grids.length - 1 ? this.state.grids.slice(0, key + 1) : this.state.grids.slice(0, key).concat(this.state.grids.slice(key + 1));
				this.setState({
					grids: newGirds,
		...
		_getStyles: function _getStyles(index) {
			var style = {};
			...
			return React.createElement(
				...
				React.createElement(
					...
					this.state.order.map((function (index, key) {
						return React.createElement(
							Motion,
							{ key: key, style: this._getStyles(index) },
							(function (style) {
								var scale = style.scale;
								var translateX = style.translateX;
								var translateY = style.translateY;
								return React.createElement(ExpandableDiv, {
									key: key,
	...
	var ExpandableDiv = React.createClass({
		...
		render: function render() {
			return React.createElement(
				...
				React.createElement(
					"span",
					{ className: "number", style: { visibility: 'hidden' } },
					this.props.name
				)
			);
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _performanceNow = __webpack_require__(22);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mergeDiff = __webpack_require__(100);
